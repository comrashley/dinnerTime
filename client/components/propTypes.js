...
//       return new Error(
//         `Invalid prop \`${propName}\` of type \`${typeof length}\` supplied to \`${componentName}\`, expected \`number\`.`
//       )
//     }

//     if (length < 0 || length > 100) {
//       return new Error(
//         `Invalid prop \`${propName}\` of type \`${typeof length}\` supplied to \`${componentName}\`, length must be between 0 and 100.`
//       )
//     }
//   }
...
//       return new Error(
//         `Invalid prop \`${propName}\` of type \`${typeof length}\` supplied to \`${componentName}\`, length must be between -100 and 100.`
//       )
//     }
//   }
