...
import {getHours, getMinutes, getSeconds} from './dates'
...
export default class Clock extends Component {
  renderMinuteMarks() {
    ...
    const {minuteMarksLength, minuteMarksWidth, renderHourMarks} = this.props
  ...
  renderHourMarks() {
    ...
    const {hourMarksLength, hourMarksWidth, renderNumbers} = this.props
